package com.wsh.springboot.springboot_rabbitmq_demo_email.utils;

import com.wsh.springboot.springboot_rabbitmq_demo_email.constants.Constants;
import com.wsh.springboot.springboot_rabbitmq_demo_email.entity.MailEntity;
...
public class EmailSendUtils {
     ...
     * @return
     */
    public EmailSendUtils setTitle(String title) {
        mail.setTitle(title);
        return this;
    }
     ...
     * @return
     */
    public EmailSendUtils setContent(String content) {
     ...
     * @return
     */
    public EmailSendUtils setContentType(String typeEnum) {
     ...
     * @return
     */
    public EmailSendUtils setSendMailTargets(List<String> targets) {
